...
export const env = createEnv({
  client: {
    ...
    NEXT_PUBLIC_STRIPE_PLAN_3_YEARLY_PRICE_ID: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_STRIPE_PLAN_3_YEARLY_PRICE_ID:
      process.env.NEXT_PUBLIC_STRIPE_PLAN_3_YEARLY_PRICE_ID,
