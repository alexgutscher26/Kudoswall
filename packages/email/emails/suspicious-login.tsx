    ...
    <BaseLayout previewText="New login detected on your KudosWall account.">
      <Section>
        ...
        <Text className="text-[14px] leading-[24px] text-neutral-700">
          We detected a new login to your KudosWall account from a device or location we haven't
          seen before.
        </Text>

        <Section className="my-8 rounded-lg border border-solid border-neutral-200 bg-neutral-50 p-6">
        ...
        <Text className="mt-4 text-[14px] leading-[24px] text-neutral-700">
          <span className="font-bold">If this wasn't you</span>, your account may be compromised.
          Please click the button below to secure your account by resetting your password and
          signing out of all active sessions.
        </Text>

        <Section className="mt-[32px] mb-[32px] text-center">
          <Button
            className="rounded-full bg-neutral-900 px-6 py-3 text-center text-[14px] font-bold text-white no-underline"
        ...
        <Text className="text-[12px] text-neutral-500 italic">
          This is an automated security alert from KudosWall. For your protection, we send these
          whenever a new login is detected.
        </Text>
      </Section>
    </BaseLayout>
  );
