...
export const metadata: Metadata = {
  title: "Privacy Policy | TestimonialWall",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Privacy Policy",
        item: "https://testimonialwall.com/privacy",
      },
    ],
  };
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-32">
      ...
      <p className="leading-relaxed text-neutral-600">
        This is a placeholder privacy policy for TestimonialWall. Full policy coming soon.
      </p>
    </main>
  );
}
